  <footer class="main-footer footer-two bgs-cover text-white">
      <div class="container">
                  ...
                  <div class="col-lg-3 col-sm-6">
                      <div class="footer-widget about-widget">
                          <div class="footer-logo mb-35">
                              <a href="<?=base_url()?>"><img src="assets/images/logos/Bitlevo-Logo.png" alt="Logo"></a>
                          </div>
                          <div class="text">
  ...
  <!-- Mirrored from tfhtml.themepul.com/restly/about-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Aug 2022 07:06:37 GMT -->
